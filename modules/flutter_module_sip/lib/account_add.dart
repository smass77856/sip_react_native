...
class AccountPageState extends State<AccountPage> {
          ...
          Padding(
            ...
            child: OutlinedButton(
              ...
              child: Wrap(
                ...
                children: [
                  Icon(
                    _advancedMode ? Icons.density_medium : Icons.density_small,
                  ),
    ...
    return Column(
      ...
      children: [
        ...
        _buildExpansionTile(
          "Audio codecs",
          false,
          _buildCodecsList(_audioCodecsList),
        ),
        const SizedBox(height: 5),
        _buildExpansionTile(
          "Video codecs",
          false,
          _buildCodecsList(_videoCodecsList),
        ),
        const SizedBox(height: 5),
  ...
  DropdownMenuItem<SipTransport> transportItem(SipTransport transp) {
    return DropdownMenuItem<SipTransport>(
      value: transp,
      child: Text(transp.name, style: Theme.of(context).textTheme.bodyMedium),
    );
  }
  ...
  Widget _buildTokenDebugInfo() {
    final token = context.watch<AppAccountsModel>().lastPushToken;
    final displayToken =
        token == null || token.isEmpty ? 'Token chưa sẵn sàng' : token;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(displayToken, style: const TextStyle(fontSize: 12)),
        ],
      ),
    );
  }
