...
class _AccountsListPageState extends State<AccountsListPage> {
  ...
  Widget _accListTile(AccountsModel accounts, int index) {
    ...
    return ListTile(
      ...
      subtitle: Text(
        'ID: ${acc.myAccId} REG: ${acc.regText}',
        overflow: TextOverflow.ellipsis,
  ...
  PopupMenuButton<AccAction> _accListTileMenu(AccountModel acc, int index) {
    return PopupMenuButton<AccAction>(
      ...
      itemBuilder:
          (BuildContext context) => <PopupMenuEntry<AccAction>>[
            ...
            PopupMenuItem<AccAction>(
              ...
              child: const Wrap(
                spacing: 5,
                children: [Icon(Icons.refresh), Text("Register")],
              ),
            ),
            PopupMenuItem<AccAction>(
              ...
              child: const Wrap(
                spacing: 5,
                children: [Icon(Icons.cancel_presentation), Text("Unregister")],
              ),
            ),
